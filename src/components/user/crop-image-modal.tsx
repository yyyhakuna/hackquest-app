...
import { Dialog, DialogContent, DialogHeader, DialogTitle } from '@hackquest/ui/shared/dialog'
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="flex max-w-[92.5%] flex-col gap-8 rounded-xl sm:max-w-xl sm:p-8">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:self-end">
          <Button variant="outline" color={'neutral'} className="w-full sm:w-[165px]" onClick={onClose}>
            Cancel
          </Button>
          <Button className="w-full sm:w-[165px]" loading={loading} onClick={onCropDone}>
            Save Changes
          </Button>
        </div>
      </DialogContent>
