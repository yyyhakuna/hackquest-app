...
import { FiAlertCircle, FiFile, FiFolder, FiLink } from 'react-icons/fi'
import { PressNav } from './type'

export const articlesData = [
  {
    title:
      'HackQuest co-hosts ETH Shanghai hackathon 2023 with Moonshot Commons and Mask Network',
    time: 'June 24, 2023',
  ...
  {
    title:
      'Mantle Network Launches Mantle Learn With HackQuest to Onboard Web2 Developers to Web3',
  ...
  },
  {
    ...
    descrption:
      '登月工坊 2022/2023 Web3冬季黑客松 Apollo Day 成功举办，共 22 个项目脱颖而出进入 Moonshot Apollo Day。',
  ...
  {
    title:
      'Web3 教育平台 HackQuest 宣布完成 110 万美元 Pre-seed 融资，STEPN、Gitcoin联创等参投',
  ...
  {
    title:
      '开发者教育平台HackQuest获得跨链独角兽公司Axelar基金会资助，将开展开发者教育合作',
  ...
  {
    title:
      'Mask Network联合Hack Quest、 Moonshot Commons登月工坊共同主办以太坊上海线上黑客松2023',
    time: 'May 29, 2023',
  ...
  {
    title:
      'HackQuest及Moonshot Commons登月工坊与Solana Foundation达成开发者生态建设合作',
    time: 'August 14, 2023',
  ...
  {
    title:
      'Viction与Web3开发者教育平台HackQuest及登月工坊达成开发者生态官方合作',
  ...
  {
    title:
      '一周融资速递 | 43家项目获投；已披露融资总额约为4.36亿美元（9.12-9.18）',
  ...
  {
    title:
      'Viction 宣布与 Web3 开发者教育平台 HackQuest 及登月工坊达成开发者生态官方合作',
    time: 'November 30, 2023',
  ...
  {
    title:
      'SevenX Ventures 与 HackQuest、MUD、DOJO、 Moonshot Commons 联合发起黑客松，聚焦全链游戏和 Web3 + AI 应用',
    time: 'August 24, 2023',
  ...
  {
    title:
      '科技创客社区 Moonshot Commons 登月工坊完成种子轮融资，真格基金等参投',
  ...
  {
    title:
      'Web3 教育平台 HackQuest 宣布完成 110 万美元 Pre-seed 融资，STEPN、Gitcoin 联创等参投',
    time: 'February 24, 2024',
  ...
  {
    title:
      'Mantle Network 宣布与 Web3 教育平台 HackQuest 合作推出 “Mantle Learn”',
    time: 'December 12, 2023',
  ...
  {
    title:
      'NEAR 基金会与 Outlier Ventures 宣布首批 NEAR Base Camp 加速器七家参与公司',
  ...
  {
    title:
      'Hackers Shine: Moonshot Commons Web3 Hackathon Concludes Successfully',
  ...
  {
    title:
      'HackQuest, Moonshot Commons and Solana Foundation reached developer ecological construction cooperation',
    time: 'August 14, 2023',
  ...
  {
    title:
      'Web3教育平台HackQuest完成110万美元Pre-Seed融资，STEPN、Gitcoin联创等参投',
    time: 'February 24, 2024',
...
export const logosData = [
  {
    ...
    img: '/images/press-kit/DoubleLine_Logo.png',
    fileName: 'DoubleLine_Logo.zip',
  },
  {
    name: 'Emblem Logo',
    img: '/images/press-kit/Emblem_Logo.png',
    fileName: 'Emblem_Logo.zip',
  },
  {
    name: 'SingleLine Logo',
    img: '/images/press-kit/SingleLine_Logo.png',
    fileName: 'SingleLine_Logo.zip',
  },
  {
    name: 'Square Logo',
    img: '/images/press-kit/Square_Logo.png',
...
export const linksData = [
  {
    img: '/images/press-kit/hackquest_log.png',
  ...
  {
    img: '/images/press-kit/discord_log.png',
  ...
  {
    img: '/images/press-kit/twitter_log.png',
  ...
  {
    img: '/images/press-kit/telegram_logo.png',
...
export const emailsData = [
  {
    img: '/images/press-kit/mail.png',
    link: 'founder@hackquest.io',
    name: 'Email (HackQuest)',
    btnText: 'Contact',
    icon: <AiOutlineArrowRight size={14} />,
  },
  {
    img: '/images/press-kit/mail.png',
    link: 'founders@moonshotcommons.com',
    name: 'Email (Moonshot Commons)',
    btnText: 'Contact',
    icon: <AiOutlineArrowRight size={14} />,
  },
]
...
export const pressKitNavData = [
  {
    id: PressNav.ABOUT,
    label: upperFirst(PressNav.ABOUT),
    icon: <FiAlertCircle size={16} />,
  },
  {
    id: PressNav.ARTICLE,
    label: upperFirst(PressNav.ARTICLE),
    icon: <FiFile size={16} />,
  },
  {
    id: PressNav.LOGO,
    label: upperFirst(PressNav.LOGO),
    icon: <FiFolder size={16} />,
  },
  {
    id: PressNav.LINK,
    label: upperFirst(PressNav.LINK),
    icon: <FiLink size={16} />,
  },
]
