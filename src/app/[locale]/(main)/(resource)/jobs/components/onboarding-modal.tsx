...
// import { MobileModalHeader } from '@/components/user/mobile-modal-header'
// import { type PersonalLinks, type ProfileSchema, personalLinks, profileSchema } from '@/components/user/profile'
...
// import { useProfile } from '@/providers/jobs/profile-provider'
// import webApi from '@/service'
// import { Button } from '@hackquest/ui/shared/button'
// import { Dialog, DialogContent } from '@hackquest/ui/shared/dialog'
// import { Form, FormControl, FormField, FormItem, FormLabel, FormMessage } from '@hackquest/ui/shared/form'
...
// import { IoIosLink as LinkedInIcon } from 'react-icons/io'
// import { IoLogoWechat as WeChatIcon } from 'react-icons/io5'
...
//         </button>
//         <Button loading={isPending} className="w-full sm:w-[270px]" onClick={onSubmit}>
//           Continue
//         </Button>
//       </div>
//     </React.Fragment>
...
//           <MoveRightIcon className="h-4 w-4" />
//         </button>
//         <Button loading={isPending} className="w-full sm:w-[270px]" onClick={() => submitRef.current?.click()}>
//           Continue
//         </Button>
//       </div>
//     </Form>
