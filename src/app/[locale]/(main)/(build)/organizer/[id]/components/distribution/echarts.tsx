...
import type {
  HackathonUtmExtend,
  OrganizerDistributionOrigin,
} from '@/graphql/generated/hooks'
import { separationNumber } from '@/lib/utils'
import ReactEcharts from 'echarts-for-react'
import { useMemo } from 'react'
import type { DistributionTab } from '../../constant'

interface GrowthEchartlineProps {
  data: HackathonUtmExtend[]
  curTab: DistributionTab
}
const GrowthEchartline: React.FC<GrowthEchartlineProps> = ({
  data,
  curTab,
}) => {
...
interface SourceEchartPieBarProps {
  data: OrganizerDistributionOrigin[]
  tab?: string
  total?: number
}
const SourceEchartPie: React.FC<SourceEchartPieBarProps> = ({
  data,
  tab,
  total,
}) => {
